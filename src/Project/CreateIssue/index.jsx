...
const ProjectCreateIssue = ({ project, fetchProject, onCreate }) => {
  ...
  return (
    <>
    <Breadcrumbs items={['Projects', project.name, 'Create Task']} />
...
ProjectCreateIssue.propTypes = propTypes;

export default ProjectCreateIssue;
